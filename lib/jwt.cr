...
module JWT
  ...
  def encoded_header(algorithm = "HS256", header_fields = {} of String => String)
  ...
  def encode(payload, key, algorithm = "HS256", header_fields = {} of String => String)
    algorithm ||= "none"
    segments = [] of String
  ...
  def decode(jwt, key = nil, verify = true, options = {} of Symbol => String, &keyfinder)
